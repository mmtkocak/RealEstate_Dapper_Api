...
namespace RealEstate_Dapper_UI.ViewComponents.EstateAgent
{
    public class _EstateAgentDashboardStatisticComponentPartial:ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage2 = await client2.GetAsync("https://localhost:44324/api/EstateAgentDashboardStatistic/ProductCountByEmployeeId?id=1");
            ...
            var responseMessage3 = await client3.GetAsync("https://localhost:44324/api/EstateAgentDashboardStatistic/ProductCountByStatusTrue?id=1");
            ...
            var responseMessage4 = await client4.GetAsync("https://localhost:44324/api/EstateAgentDashboardStatistic/ProductCountByStatusFalse?id=1");
