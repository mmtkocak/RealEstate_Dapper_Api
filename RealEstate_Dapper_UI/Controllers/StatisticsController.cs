...
namespace RealEstate_Dapper_UI.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage6 = await client6.GetAsync("https://localhost:44324/api/Statistics/AverageRoomCount");
            ...
            var responseMessage9 = await client9.GetAsync("https://localhost:44324/api/Statistics/CityNameByMaxProductCount");
